...
//            loading excel file into java XSSF object 
 			...
 			System.out.println("file name inside excel getdata() is : " + Constants.PATH + fileName);
           XSSFSheet sheet =  wb.getSheet("Login");
             
  
           int rows = sheet.getLastRowNum();  // gies index alue for last row
           ...
           for(int i = 1; i < rows; i ++ ) {
        	  ...
        	  int noOfCols = row.getLastCellNum(); // gives last value for last column
