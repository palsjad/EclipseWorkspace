...
public class ByClass {
	...
	public static By getByObject(String key) {    // ceate By object for locator and return the object
 ...
 * 
 * 	try {
			Properties prop = ConfigUtils.loadProperties(Constants.PATH+ "\\locators\\homepage-locators.properties");
