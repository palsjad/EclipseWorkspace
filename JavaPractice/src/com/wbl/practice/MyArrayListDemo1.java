...
public class MyArrayListDemo1 {
 ...
 //	Object[] myArray;
	...
	myArray[count]	= x;
//	System.out.println("inside add -   x " + x + " count : " + count + "  value of  myarray[y] " + myArray[count]);
	...
	public Integer[] remove(MyArrayListDemo1 mal,Integer[] myArr, int x) {
	...
	public static void main(String[] args) {
 		MyArrayListDemo1 mal = new MyArrayListDemo1();
		...
		myArray = mal.remove(mal,myArray,3);  // enterr the index number to be deleted
