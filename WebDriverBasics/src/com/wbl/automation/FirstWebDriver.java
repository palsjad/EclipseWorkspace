...
public class FirstWebDriver {
	...
	System.setProperty("webdriver.chrome.driver", "C:\\QA\\EclipseWorkspace\\WebDriverBasics\\resource\\chromedriver.exe");
	
//	C:\QA\EclipseWorkspace\WebDriverBasics\resource
 ...
 //  By by1 = By.cssSelector(".header-GlobalSearch-submit.btn");  // we can use either css or xpath to select the same attribute..in
  ...
  // By by1 = By.cssSelector("class='header-GlobalSearch-submit btn'");
	
	By by1 = By.cssSelector("button[class='header-GlobalSearch-submit btn']");
